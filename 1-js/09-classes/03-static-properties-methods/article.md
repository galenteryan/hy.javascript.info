...
Սովորաբար ստատիկ մեթոդներն օգտագործվում են այնպիսի ֆունկցիաներ իրագործելու համար, որոնք պատկանում են class-ին որպես ամբողջություն, բայց ոչ դրա որևէ կոնկրետ օբյեկտին:
