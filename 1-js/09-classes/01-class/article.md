...
Տեխնիկապես, class-ի այդպիսի հայտարարագիրը աշխատում է `User.prototype`-ում գեթթերներ և սեթթերներ ստեղծելով:
...
Հաջորդ գլուխներում մենք ավելին կիմանանք class-ների մասին՝ ներառյալ ժառանգությունն ու այլ առանձնահատկությունները:
