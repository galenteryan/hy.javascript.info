...
Եթե չեք ցանկանում իմանալ մանրամասները, ապա կարող եք բաց թողնել այս մասը և անցնել `[[HomeObject]]` ենթաբաժնին: Դա չի վնասի: Կամ ընթերցեք, եթե սիրում եք ամեն ինչ խորությամբ հասկանալ:
...
Նախ տեսնենք, թե ինչպես է այն աշխատում պարզ օբյեկտների հետ.
