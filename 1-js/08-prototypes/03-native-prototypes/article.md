...
Այս հատուկ արժեքները՝ `null` և `undefined`, առանձնանում են: Դրանք չունեն օբյեկտ-պատյաններ, ուստի դրանց համար չկան մեթոդներ և հատկություններ: Չկան նաև համապատասխան նախատիպեր։
```
...
- Պրիմիտիվները պահում են մեթոդները նաև պատյանային օբյեկտների նախատիպերում՝ `Number.prototype`, `String.prototype` և `Boolean.prototype`: Միայն `undefined`-ը և `null`-ը չունեն պատյանային օբյեկտներ:
