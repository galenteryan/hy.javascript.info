...
Նկատի ունեցեք, որ օբյեկտների հետ կապված մեթոդներից շատերը `Object.something(...)` են, ինչպես `Object.keys(obj)`-ը. դրանք նախատիպում չեն, ուստի կշարունակեն աշխատել նմանատիպ օբյեկտների համար.
